...
public class ContenidoService {
    ...
    private interface TipoOps {
        ...
        StreamingTarget buildTarget(Contenido c) throws StreamingTargetException, Exception;
    }
    ...
    private final TipoOps audioOps = new TipoOps() {
        ...
        @Override public StreamingTarget buildTarget(Contenido c) throws StreamingTargetException, Exception {
    ...
    private String nonBlankOrNull(String s) { return (s != null && !s.isBlank()) ? s : null; }
