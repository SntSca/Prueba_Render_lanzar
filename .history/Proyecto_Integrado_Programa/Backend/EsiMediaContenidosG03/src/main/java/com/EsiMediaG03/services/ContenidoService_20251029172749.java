...
public class ContenidoService {
    ...
    public Contenido modificarContenido(String id,
        ...
        // Permisos: solo por coincidencia de tipo (se ignora requesterEmail y cualquier rol)
        checkPermisosPorTipo(actual, requesterTipo, "modificar");

        // No permitir cambiar tipo o userEmail (creador)
        // (El DTO no los trae; si los recibieras por otra vía, rechazar aquí.)

        // Patch de campos permitidos
    ...
    /**
     * Permisos:
     * - CREADOR de tipo T: puede modificar/eliminar cualquier contenido de tipo T.
     * - Mismatch de tipo: prohibido (no puede ni modificar ni eliminar).
     * - El email del autor no se considera para permisos.
     */
