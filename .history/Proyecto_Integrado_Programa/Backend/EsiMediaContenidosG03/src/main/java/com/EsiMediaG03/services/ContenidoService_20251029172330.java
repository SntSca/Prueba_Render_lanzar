...
public class ContenidoService {
    ...
    public Contenido modificarContenido(String id,
        ...
        // 1) Permisos según reglas
        checkPermisosSobreContenido(actual, requesterEmail, requesterRole, requesterTipo, "modificar");

        // 2) Prohibido cambiar tipo o userEmail (creador) — el DTO no los trae; si llegaran, rechazar aquí.

        // 3) Patch de campos permitidos
        ...
        // 4) Validaciones de negocio existentes
    ...
    private void checkPermisosSobreContenido(Contenido c,
        ...
        // Tipos deben coincidir exactamente (regla explícita)
