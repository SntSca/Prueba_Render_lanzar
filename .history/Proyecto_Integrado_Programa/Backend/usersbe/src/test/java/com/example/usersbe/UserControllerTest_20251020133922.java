...
class UserControllerTest {
    ...
    void crear_creador_por_admin_ok() throws Exception {
        doNothing().when(userService).registrar(
                anyString(), anyString(), anyString(), anyString(), anyString(),
                anyString(), anyBoolean(), anyString(), eq(User.Role.GESTOR_CONTENIDO),
                any(), any(), any(), isNull()
        );
        var body = Map.of(
                "nombre","N","apellidos","A","email","c@mail.com",
                "alias","al","pwd","Aa1!aaaa","pwd2","Aa1!aaaa",
                "foto","f.png","especialidad","esp","tipoContenido","AUDIO"
        );
