...
class UserServiceUsuariosTest {
    ...
    void actualizarUsuario_ok() {
        ...
        // No stubbear findByAlias aquí para evitar UnnecessaryStubbing
    ...
    void actualizarUsuario_aliasDuplicado() {
        ...
        // Stub genérico para cubrir trims/case del alias nuevo:
        when(userDao.findByAlias(anyString())).thenAnswer(inv -> {
            String a = inv.getArgument(0, String.class);
            return a != null && a.trim().equalsIgnoreCase("dup") ? otro : null;
        });
