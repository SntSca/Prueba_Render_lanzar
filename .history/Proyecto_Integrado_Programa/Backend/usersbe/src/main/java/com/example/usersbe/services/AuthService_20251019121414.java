...
public class AuthService {
    ...
    private static final String DUMMY_BCRYPT = 
            "$2a$10$" + "ReplaceThisWithASecurelyGeneratedValue";
    ...
    public User login(String email, String rawPassword) {
        ...
        if (u == null) {
            encoder.matches("invalid", DUMMY_BCRYPT);
            encoder.matches("invalid", DUMMY_BCRYPT); // Ensure this is used only for timing attack prevention
        }
