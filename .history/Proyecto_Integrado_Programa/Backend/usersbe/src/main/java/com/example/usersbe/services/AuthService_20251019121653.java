...
public class AuthService {
    ...
    private static final String DUMMY_BCRYPT_HASH =
            "$2a$10$abcdefghijklmnopqrstuvABCDEFGHIJKLMNOpqrstuvwxyz123456";
    ...
    public User login(String email, String rawPassword) {
        ...
        if (u == null) {
            // Intentionally perform a bcrypt hash check with a random value to prevent timing attacks
            encoder.matches("invalid", encoder.encode("randomValue"));
