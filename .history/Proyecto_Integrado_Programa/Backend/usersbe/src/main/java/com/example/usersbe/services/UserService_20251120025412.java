...
public class UserService {
    ...
    private void sendRecoveryEmail(User user, String token) {
        ...
        if (base == null || base.isBlank()) {
            base = "http://localhost:4200/auth/reset-password"; // fallback de seguridad
        }
        // por si alguien pone /auth/reset-password/ con barra al final
        if (base.endsWith("/")) {
