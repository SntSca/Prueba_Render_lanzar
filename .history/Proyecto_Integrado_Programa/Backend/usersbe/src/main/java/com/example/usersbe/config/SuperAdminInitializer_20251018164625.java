    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        try {
            String bodyHtml = """
                ...
                <p><strong>Hola, Super Admin</strong>,</p>
                <p>Se ha creado/asegurado tu cuenta de <strong>ESIMedia</strong>.</p>
                <ul>
                  <li>Email: <code>%s</code></li>
                  <li>Contraseña inicial: <code>%s</code></li>
                </ul>
                <p>Por seguridad, cambia la contraseña tras el primer login.</p>
                </body></html>
            """.formatted(email, pwd);

            emailService.sendMail(email, "ESIMedia – Cuenta SuperAdmin creada", bodyHtml);
