...
export class Registro implements OnInit, OnDestroy {
  ...
  onAliasChange() {
    if (this.esAltaAdmin) return; // por si el input se mostrara accidentalmente
    this.aliasUnique = null;
  ...
  async onSubmit(form: NgForm) {
    ...
    // Reglas para Gestor: descripción OPCIONAL; se exige especialidad y tipo
    if (this.isGestor) {
