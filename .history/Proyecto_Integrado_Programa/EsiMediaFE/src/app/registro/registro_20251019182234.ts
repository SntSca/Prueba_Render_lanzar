...
export class Registro implements OnInit, OnDestroy {
  ...
  /**
   * SHA-1 hash solo para consulta de contraseñas en Have I Been Pwned.
   * ⚠️ ADVERTENCIA: SHA-1 es considerado débil.
   * Solo usar aquí, no almacenar ni autenticar con este hash.
   */
  ...
  /**
   * Comprueba si una contraseña aparece en Have I Been Pwned.
   */
