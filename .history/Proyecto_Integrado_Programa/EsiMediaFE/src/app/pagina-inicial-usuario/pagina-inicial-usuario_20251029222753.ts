...
public cargarContenidos(): void {
  ...
  /**
   * Intenta resolver el contenido y cuenta la reproducción.
   * Si ocurre el error HTTP0_OPAQUE, intenta abrir externamente.
   */
  ...
  /**
   * Maneja la reproducción externa (enlace HTTP o tipo 'external')
   */
  ...
  /**
   * Maneja la reproducción interna (player embebido)
   */
