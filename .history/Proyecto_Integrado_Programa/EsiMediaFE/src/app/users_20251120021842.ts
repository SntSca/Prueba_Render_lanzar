...
import { environment } from 'Proyecto_Integrado_Programa\EsiMediaFE\src\app\environments'; // ajusta la ruta si hace falta
C:\Users\USUARIO\Desktop\GPS_EsiMedia_G03 - copia\Proyecto_Integrado_Programa\EsiMediaFE\src\app\environments\environment.ts
