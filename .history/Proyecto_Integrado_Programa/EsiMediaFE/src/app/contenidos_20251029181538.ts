...
export class Contenidos {
  ...
  /** POST /Contenidos/AnadirContenido */
  ...
  /** PUT /Contenidos/ModificarContenido/{id}  (cabecera X-Creator-Tipo requerida) */
  ...
  /** DELETE /Contenidos/EliminarContenido/{id}  (cabecera X-Creator-Tipo requerida) */
