...
public class ContenidoController {
    ...
    @PostMapping("/EliminarContenido")
        public ResponseEntity<Void> eliminarContenido(@RequestBody EliminarContenidoRequest request) {
            try {
                boolean eliminado = contenidoService.eliminarContenido(request.getId());
                if (eliminado) {
