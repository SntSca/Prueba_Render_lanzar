...
public class SuperAdminMongoGuard extends AbstractMongoEventListener<User> {
    ...
    @Override
    public void onBeforeDelete(@SuppressWarnings("null") BeforeDeleteEvent<User> event) {
    ...
    @Override
    public void onBeforeSave(@SuppressWarnings("null") BeforeSaveEvent<User> event) {
