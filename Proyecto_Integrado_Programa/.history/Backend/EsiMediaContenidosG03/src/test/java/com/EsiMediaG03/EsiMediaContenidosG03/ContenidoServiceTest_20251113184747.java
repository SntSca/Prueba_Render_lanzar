...
void top5PorReproducciones_ok() {
    ...
    assertEquals(10L, top.get(0).get("reproducciones")); // <-- coincide con FIELD_REPRODUCCIONES
}
    ...
    void top5CategoriasMasVistas_ok() {
        ...
        c1.setNumReproducciones(10);

        Contenido c2 = new Contenido();
        c2.setUserEmail("b@b.com");
        c2.setNumReproducciones(20);
        ...
        assertEquals(20L, top.get(0).get("numReproducciones"));}
}
