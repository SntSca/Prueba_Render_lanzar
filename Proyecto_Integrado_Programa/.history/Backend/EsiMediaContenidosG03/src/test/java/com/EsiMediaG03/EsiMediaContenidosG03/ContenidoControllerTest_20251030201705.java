...
class ContenidoControllerTest {
    ...
    void stream_sinRange_ok() throws Exception {
        ...
        Assertions.assertTrue(HttpStatus.OK, resp.getStatusCode());
        Assertions.assertTrue("application/octet-stream", resp.getHeaders().getFirst(HttpHeaders.CONTENT_TYPE));
        Assertions.assertTrue("bytes", resp.getHeaders().getFirst(HttpHeaders.ACCEPT_RANGES));
        Assertions.assertTrue(26, resp.getHeaders().getContentLength());
    ...
    void stream_conRange_206() throws Exception {
        ...
        Assertions.assertTrue(HttpStatus.PARTIAL_CONTENT, resp.getStatusCode());
        Assertions.assertTrue("bytes 0-9/26", resp.getHeaders().getFirst(HttpHeaders.CONTENT_RANGE));
        Assertions.assertTrue(10L, resp.getHeaders().getContentLength());
    }
    ...
    void stream_fueraDeRango_416() throws Exception {
        ...
        Assertions.assertTrue(HttpStatus.REQUESTED_RANGE_NOT_SATISFIABLE, resp.getStatusCode());
        Assertions.assertTrue("bytes */26", resp.getHeaders().getFirst(HttpHeaders.CONTENT_RANGE));
    ...
    void stream_redireccionExterna_302() throws Exception {
        ...
        Assertions.assertTrue(HttpStatus.FOUND, resp.getStatusCode());
        Assertions.assertTrue("https://cdn.example.com/video.mp4", resp.getHeaders().getFirst(HttpHeaders.LOCATION));
    }
    ...
    void head_ok() throws Exception {
        ...
        Assertions.assertTrue("application/octet-stream", resp.getHeaders().getFirst(HttpHeaders.CONTENT_TYPE));
        Assertions.assertTrue("bytes", resp.getHeaders().getFirst(HttpHeaders.ACCEPT_RANGES));
        Assertions.assertTrue("26", resp.getHeaders().getFirst(HttpHeaders.CONTENT_LENGTH));
    }
    ...
    void eliminarContenido_noContent() {
        ...
        Assertions.assertTrue(HttpStatus.NO_CONTENT, resp.getStatusCode());
