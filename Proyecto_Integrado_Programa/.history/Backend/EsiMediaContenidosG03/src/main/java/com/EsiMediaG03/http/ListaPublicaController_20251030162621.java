...
public class ListaPublicaController {
    ...
    public ListaPublica añadirContenidoALista(@PathVariable String listaId, @PathVariable String contenidoId) {
        return listaService.añadirContenidoALista(listaId, contenidoId);
    }

    // ✅ Nuevo endpoint: eliminar contenido de la lista
