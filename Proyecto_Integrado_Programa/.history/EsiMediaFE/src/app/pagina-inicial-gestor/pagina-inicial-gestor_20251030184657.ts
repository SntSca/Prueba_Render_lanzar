...
availableTags = {
  ...
  crearListaPublica() {
    ...
    if (!descripcion) { // descripción obligatoria
      void showAlert('Error', 'Debes indicar una descripción para la lista.', 'error');
      return;
    }
    ...
    const nuevaLista = {
      nombre,
      descripcion,              // <— enviar descripción del formulario
      userEmail: this.userEmail,
      visibilidad: 'PUBLICA'    // si tu API lo admite
    };
