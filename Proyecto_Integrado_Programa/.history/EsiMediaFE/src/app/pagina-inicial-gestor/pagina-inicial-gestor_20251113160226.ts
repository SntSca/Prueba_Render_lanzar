...
export class PaginaInicialGestor implements OnInit {
  ...
  resetFiltros() {
    ...
    this.pageIndex = 1; // Reset to first page when filters are reset
  }
  ...
  private toLdtFromYmd(ymd?: string | null): string | null {
    ...
    // Paginación
  pageIndex = 1;          // página actual (1-based)
  ...
  onPageSizeChange(size: number): void {
    ...
    this.pageIndex = 1; // reseteamos a la primera página al cambiar tamaño
  }
