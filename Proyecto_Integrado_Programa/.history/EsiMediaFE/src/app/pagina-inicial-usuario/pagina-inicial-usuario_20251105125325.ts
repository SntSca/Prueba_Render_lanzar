...
goMisFavoritos(): void {
  ...
  // ✅ Si ya está en modo favoritos → volver al catálogo completo
  ...
  // ✅ Guardamos copia del catálogo actual
  ...
  // ✅ Si no hay favoritos → restaurar catálogo completo automáticamente
  ...
  // ✅ Si sí hay -> activar modo favoritos
