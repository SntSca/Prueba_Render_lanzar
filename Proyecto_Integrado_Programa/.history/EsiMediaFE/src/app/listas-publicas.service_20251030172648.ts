...
añadirContenido(listaId: string, contenidoId: string): Observable<ListaPublica> {
    // URL corregida según tu controlador: POST /listas/{listaId}/contenidos/{contenidoId}
  ...
  eliminarContenido(listaId: string, contenidoId: string): Observable<ListaPublica> {
    // URL corregida según tu controlador: DELETE /listas/{listaId}/contenidos/{contenidoId}
