...
public class UserService {
    ...
    User user = buildUser(
        nombre, apellidos, alias, emailN, fechaN, pwd,
        /*vip*/ false,
        foto,
        /*role*/ User.Role.ADMINISTRADOR, // lo guardamos ya como admin…
        /*descripcion*/ null,
        /*especialidad*/ null,
        /*tipoContenido*/ null,
    ...
    // Bloquea/deshabilita el acceso hasta la aprobación
    user.setBlocked(true);                         // clave: no podrá autenticarse
    user.setEnabled(false);                        // si tienes este campo, mejor aún
